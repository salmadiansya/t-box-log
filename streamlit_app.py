...
options = st.sidebar.radio("Select Option", ["View Logs", "Add Log Entry", "Search Logs", "Student Data"])

if options == "View Logs":
    st.header("View Logs")
